  ...
  return (
    <section data-section id="about" className="relative">
      <div className="container-shell flex flex-col gap-10">
        <h3 className="text-[clamp(2rem,5vw,3.25rem)] font-display tracking-wide bg-gradient-to-br from-[#009e60] to-[#004d28] dark:from-[#5fffa1] dark:to-[#0d8f4a] bg-clip-text text-transparent drop-shadow-[0_4px_16px_rgba(0,64,32,0.18)]">WHO ARE WE</h3>
        ...
        <div className="rounded-xl md:rounded-2xl bg-[var(--color-brand-dark)] text-white p-8 md:p-10 max-w-3xl">
